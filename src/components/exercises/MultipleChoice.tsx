...
import type { MultipleChoiceProps, ExerciseState, FeedbackMessage } from './types';
import {
...
export function MultipleChoice({
  ...
  useEffect(() => {
    ...
    const shuffled = shuffleOptions(options, question.questionData.shuffleOptions);
  ...
  const handleSubmit = useCallback(() => {
    ...
    const validation = validateAnswer(question, selectedOption, state.hintsUsed, state.timeSpent);
    const newState = updateExerciseState(state, selectedOption, validation.isCorrect);
  ...
  }, [disabled, state.isAnswered, shuffledOptions, focusedOptionIndex, selectedOption, handleOptionSelect, handleSubmit, handleHintRequest]);
      ...
      <Card.Body>
        ...
        >
          {shuffledOptions.map((option, index) => {
            ...
            const isCorrect = state.isAnswered && option === question.correctAnswer;
