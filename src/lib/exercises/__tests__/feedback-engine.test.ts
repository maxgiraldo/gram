...
describe('Feedback Engine', () => {
  ...
  describe('generateFeedback', () => {
    ...
    it('should adjust title based on hints used', () => {
      const contextNoHints = { ...mockContext, userAnswer: 'Paris', hintsUsed: 0 };
      const contextWithHints = { ...mockContext, userAnswer: 'Paris', hintsUsed: 2 };
  ...
  describe('generateHintSequence', () => {
    ...
    it('should generate type-specific hints for multiple choice', () => {
      const sequence = generateHintSequence(mockQuestion);
      const strategicHint = sequence.hints.find(h => h.category === 'strategy');
    ...
    it('should generate type-specific hints for fill-in-blank', () => {
      ...
      const hints = sequence.hints.filter(h => h.category === 'strategy' || h.category === 'grammar');
